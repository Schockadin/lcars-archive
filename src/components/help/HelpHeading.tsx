...
//
// items-start statt items-center: Die h1 bringt ihren eigenen Abstand nach
// unten mit (margin-bottom: 20px, siehe globals.css); zentriert hinge der
// Knopf dadurch schief unter der Schrift.
export default function HelpHeading({
  ...
  // abweicht (z.B. „Erfahrungspunkte" → Fenster „AP der Runde").
  helpTitle?: string;
...
// Dieselbe Zeile für Seiten, deren Überschrift nicht aus HelpHeading kommen
// kann: Charakterliste, Chronologie, Datenbank und Suche tragen eine eigene
// Klasse an der h1 (lcars-data-row-heading) und ihre Augenbraue UNTER der
// Überschrift. Drei von ihnen bauen ihre Kopfzeile außerdem in einer
