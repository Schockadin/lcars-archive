...
export default async function LcarsHeaderBox() {
  ...
  return (
    // <div className="flex flex-col items-end gap-[10px] mb-[5px] min-w-0 overflow-hidden">
    //   {/* ── Zeile 1: Heading / Nav ── */}
    ...
    <div className="flex flex-col items-end gap-[10px] mb-[5px]">
      ...
      <div className="flex items-center gap-[16px]">
        ...
        />
        <LcarsContextTag label="Letzter Eintrag" value="Session 1" />
        <ContextSep />
        <LcarsContextTag label="Erzähler" value="Desmond Hobbes" />
        <ContextSep />
        <LcarsContextTag label="Datum" value="12.03.2240" />
      </div>
    </div>
  );
}
