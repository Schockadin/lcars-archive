  ...
  return (
    <div className="flex flex-col bg-[var(--lcars-bg)] gap-[5px]">
      <div className="lcars-elbow-bar gap-[5px]">
        <div className="w-[35%] h-[var(--lcars-bar-h)] bg-[var(--lcars-blue)]" />
        <div className="w-[5%] h-[var(--lcars-bar-h)] bg-[var(--lcars-amber)]" />
        <div className="w-[20%] h-[var(--lcars-bar-h)] bg-[var(--lcars-purple)]" />
        <div className="w-[35%] h-[var(--lcars-bar-h)] bg-[var(--lcars-purple)]" />
        <div className="w-[5%] h-[var(--lcars-bar-h)] bg-[var(--lcars-red)]" />
      </div>
      <div className="lcars-elbow-bar gap-[5px]">
        <div className="w-[35%] h-[var(--lcars-bar-h)] bg-[var(--lcars-red)]" />
...
export function FooterBar({ appVersion }: { appVersion: string | null }) {
  return (
    <div className="lcars-elbow-bar gap-[5px]">
      <div className="w-[25%] h-[var(--lcars-bar-h)] bg-[var(--lcars-purple)]" />
