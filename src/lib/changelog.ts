...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Das Werte-Formular ist dem Charakterbogen nachempfunden: Abschnitte mit farbiger Kopfleiste, Attribute und Disziplinen als Wertekästen mit großer Zahl, anklickbare Entschlossenheits-Kästchen und linierte Listenfelder. Dabei gelten jetzt die Regeln der Runde — Attribute 7–12 (höchstens eines auf 12, zwei auf 11), Disziplinen 1–5 (höchstens eine auf 5, zwei auf 4); Verstöße werden sofort markiert. Der maximale Stress wird aus Fitness und dem Bonus aus Talenten berechnet, statt von Hand eingetragen zu werden.",
    ],
  },
  {
    version: "1.26",
