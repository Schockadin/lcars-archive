...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "NPCs lassen sich jetzt direkt anlegen: unter „Meine Inhalte“ gibt es für die Spielleitung den Knopf „Neuer NPC“ — dasselbe Formular wie für Charaktere, nur ohne Spieler dahinter.",
