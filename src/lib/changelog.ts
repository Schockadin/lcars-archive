...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  {
    version: "1.15",
    title: "Rollen-Hochstufung behoben, Markdown-Import für Admins, Dialoge moderierbar",
    summary:
      "Ein hartnäckiger Fehler ist behoben: bei jeder technischen Datenbank-Aktualisierung wurde die Rolle bestehender Spielleitungs-Accounts automatisch und ohne Ankündigung auf Administration hochgestuft, statt unverändert zu bleiben. Dadurch konnte eine bewusst auf Spielleitung zurückgestufte Person nach einem Update ungewollt wieder volle Administrationsrechte bekommen, ohne dass das irgendwo protokolliert wurde. Zusätzlich ist abgesichert, dass die im Header angezeigten Anmeldedaten (Name, Rolle) nie über einen Zwischenspeicher an die falsche Person ausgeliefert werden können. Neu im Adminbereich: unter „Import“ lassen sich eine oder mehrere Markdown-Dateien im gewohnten Vault-Format hochladen, aus denen nach individueller Bestätigung neue Archiv-Einträge, Missionen oder Charaktere entstehen – inklusive Vorschau vor dem endgültigen Anlegen und automatischer Verlinkung erkannter Querverweise; bereits vergebene Adressen (Slugs) werden dabei abgelehnt statt versehentlich überschrieben. Außerdem dürfen Admins und Spielleitung jetzt Nachrichten in jedem Gespräch bearbeiten oder löschen, auch fremde und auch in bereits abgeschlossenen Gesprächen – bisher war das ausschließlich der ursprünglichen Autorin oder dem Autor und nur in noch offenen Gesprächen möglich.",
  },
];
