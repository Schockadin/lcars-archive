...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Der Datenbank-Bereich wurde überarbeitet: Das SQL-Feld erlaubt je nach Recht nicht mehr nur Lesen, sondern auch Schreiben und Löschen; das Backup-Panel ist an das DB-Backup-Recht gebunden; und statt der Tabellen-Buttons gibt es jetzt ein interaktives ER-Diagramm der Datenbank (Tabellen, Beziehungen, Spalten) zum Zoomen und Erkunden.",
      "Die Timeline ist jetzt ein interaktiver Story-Graph: Charaktere, Missionen und Archiv-Einträge erscheinen als Knoten, ihre internen Verlinkungen als Verbindungen. Ein Jahr-Regler (mit Eingabefeld) oben blendet die Geschichte kumulativ ein — je weiter nach rechts, desto mehr des Verlaufs wird sichtbar.",
      "Behoben: Der Story-Graph (Timeline) und das ER-Diagramm (Datenbank-Bereich) wurden auf Handys gar nicht angezeigt — die Grafikfläche fiel dort auf Höhe 0 zusammen; sie füllt jetzt wieder korrekt die Höhe.",
      "Im Datenbank-Bereich lässt sich eine Zeile im Detail-Overlay jetzt — je nach Recht — direkt bearbeiten (Felder ändern und speichern) oder löschen. Angeboten wird das nur bei Abfragen auf eine einzelne Tabelle mit eindeutiger Zeile.",
