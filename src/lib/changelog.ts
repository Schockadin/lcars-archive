...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Ein hartnäckiger Fehler ist behoben: bei jeder technischen Datenbank-Aktualisierung wurde die Rolle bestehender Spielleitungs-Accounts automatisch auf Administration hochgestuft, statt unverändert zu bleiben, und die im Header angezeigten Anmeldedaten können nun nicht mehr über einen Zwischenspeicher an die falsche Person ausgeliefert werden. Neu im Adminbereich: unter „Import“ lassen sich Markdown-Dateien im gewohnten Vault-Format hochladen, aus denen nach individueller, durchblätterbarer und noch bearbeitbarer Vorschau neue Archiv-Einträge, Missionen, Charaktere oder Missionslogs entstehen; das manuelle DB-Backup fragt jetzt außerdem, ob lokal oder direkt im Cloud-Speicher gesichert (und von dort auch wieder eingespielt) werden soll. Bei den Gesprächen gibt es viele Änderungen: nur noch die Administration darf fremde Nachrichten bearbeiten/löschen oder den Besitzer ändern, abgeschlossene Gespräche zeigen standardmäßig einen zusammenhängenden Lesetext, und wer mit mehreren eigenen Charakteren teilnimmt, kann nicht zweimal hintereinander mit demselben antworten. Gespräche können jetzt außerdem schon bei der Erstellung (oder jederzeit danach) mehr als zwei Teilnehmende haben — sobald mehr als zwei mitspielen, muss man sich das Antwortrecht erst für zwei Stunden reservieren, mit Sperr-Anzeige und optionaler Mail/Push-Benachrichtigung, sobald die Sperre endet; offene Gespräche aktualisieren sich dabei automatisch, neue Nachrichten erscheinen ohne manuelles Neuladen.",
  },
];
