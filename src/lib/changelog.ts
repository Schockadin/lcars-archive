...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    summary:
      "Der Adminbereich war bisher eine einzige lange Seite mit aufklappbaren Abschnitten – jetzt gibt es unterhalb des Headers eine Pill-Navigation zu klar getrennten Unterseiten: User, Charaktere, DB, Scripts, Inhalte und Audit-Log. Die Nutzerübersicht zeigt jetzt eine richtige Tabelle mit Suche, Filter und Sortierung (per Klick auf die Spaltenüberschrift), inklusive der Zeitpunkte des letzten Logins und des letzten Seitenaufrufs; die eigentliche Kontoverwaltung (Rolle, Aktivierung, Löschen, Passwort-Reset, Geräte abmelden) findet sich gebündelt auf der Detailseite eines Users. Neu auf der DB-Seite: Admins können sich die Inhalte der wichtigsten Datenbank-Tabellen jetzt direkt und rein lesend ansehen, ohne dafür erst ein Backup exportieren zu müssen. Das Audit-Log zeigt neben den sicherheitsrelevanten Useraccount-Aktionen jetzt zusätzlich, welche Inhalte (Charaktere, Missionen, Logs, Archiv-Einträge) in den letzten drei Tagen hinzugefügt, bearbeitet oder gelöscht wurden. Und im Hintergrund räumt ein täglicher Cronjob automatisch DB-Backups auf, die älter als 30 Tage sind. Wer eine Mission oder einen Archiv-Eintrag abonniert hat, bekommt jetzt außerdem eine Benachrichtigung, wenn genau dieser Inhalt bearbeitet wird – bisher gab es das nur bei abonnierten Charakteren.",
  },
];
