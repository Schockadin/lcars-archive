...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  {
    version: "1.15",
    title: "Rollen-Hochstufung behoben, Markdown-Import für Admins, Dialoge überarbeitet",
    summary:
      "Ein hartnäckiger Fehler ist behoben: bei jeder technischen Datenbank-Aktualisierung wurde die Rolle bestehender Spielleitungs-Accounts automatisch und ohne Ankündigung auf Administration hochgestuft, statt unverändert zu bleiben, und die im Header angezeigten Anmeldedaten können nun nicht mehr über einen Zwischenspeicher an die falsche Person ausgeliefert werden. Neu im Adminbereich: unter „Import“ lassen sich eine oder mehrere Markdown-Dateien im gewohnten Vault-Format hochladen, aus denen nach individueller Bestätigung neue Archiv-Einträge, Missionen oder Charaktere entstehen, inklusive Vorschau und automatischer Verlinkung erkannter Querverweise. Bei den Gesprächen gibt es mehrere Änderungen: nur noch die Administration darf fremde Nachrichten bearbeiten/löschen oder den Besitzer eines Gesprächs ändern (vorher war das teils auch der Spielleitung oder niemandem möglich, teils fälschlich mit „Eintrag nicht gefunden“ blockiert); abgeschlossene Gespräche zeigen standardmäßig einen zusammenhängenden Lesetext statt der farbigen Nachrichten-Karten offener Gespräche, per Umschalter auf der Seite aber weiterhin wie gewohnt einsehbar; und wer mit mehreren eigenen Charakteren teilnimmt, kann nicht mehr mit demselben Charakter zweimal hintereinander antworten. Kleinere Verbesserungen: die Vorschau von Autolinking/Wikilinks-Entfernen ist jetzt ein zentriertes, auf allen Bildschirmgrößen gut lesbares Overlay mit Icon-Buttons, und die Teilnehmer-Auswahl beim Anlegen einer Mission blendet nicht mehr aktive Charaktere standardmäßig aus.",
  },
];
