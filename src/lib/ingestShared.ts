// Reine Frontmatter-/Slug-Hilfsfunktionen, ursprünglich nur in
// scripts/ingest/shared.ts. Hierher verschoben, damit sie sowohl von den
// CLI-Ingest-Skripten (per Re-Export, siehe scripts/ingest/shared.ts) als
// auch von src/lib/markdownImport.ts (Admin-Markdown-Upload im laufenden
// Next.js-Prozess, kein @/-Alias-Problem) genutzt werden können — eine
// einzige Quelle für Validierungslogik statt zweier driftender Kopien.
