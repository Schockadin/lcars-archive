...
// Skeleton-Fallback der Live-Gesprächsseite (force-dynamic, mehrere serielle
// DB-Schritte) — zeigt Kopf + ein paar Nachrichten-Platzhalter, damit die
// Navigation sofort reagiert statt „leer" zu wirken.
