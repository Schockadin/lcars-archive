    ...
    <main className="text-justify" style={{
      ...
      <div className="mt-[16px]">
        ...
        <div style={{
          ...
          <p>
            Seit über fünfzehn Jahren wird die Welt von NeoVerse gespielt, beschrieben
            und erweitert. Was einmal als Abenteuer an einem Tisch begann, ist heute ein
            dichtes Geflecht aus Geschichte, Figuren und Orten — gewachsen durch jede
            Entscheidung, die an diesem Tisch getroffen wurde.
          </p>
          <p>
            Dieses Terminal ist das Gedächtnis dieser Welt. Es bewahrt, was erlebt wurde:
            die Sitzungsberichte, die Charakterbögen, die Orte und die Ereignisse, die
            NeoVerse zu dem gemacht haben, was es ist. Kein Roman, kein Regelwerk —
            sondern das Protokoll einer gemeinsamen Geschichte.
          </p>
