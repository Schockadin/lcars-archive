  ...
  return (
    <div className="flex flex-col gap-[16px] sm:flex-row sm:gap-[24px]">
      ...
      <div className="flex-1 min-w-0">
        ...
        {selected && data?.error && (
          <p className="text-lcars-quinary-ink text-[13px]">{data.error}</p>
        )}
          ...
          <>
            <div className="db-explorer-toolbar mb-[8px]">
              <div className="flex items-center gap-[8px]">
                <h3 className="text-lcars-primary-ink font-bold text-[14px]">
                  {selected}
                </h3>
            ...
            {!loading && data.rows.length > 0 && (
              <div className="overflow-x-auto">
                <table className="w-full text-left text-[13px]">
                  <thead>
                    <tr className="text-lcars-primary-ink">
                      {data.columns.map((c) => (
                        <th
                          key={c}
...
function InsertRowModal({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lcars-primary-ink">Neue Zeile — {table}</h2>
